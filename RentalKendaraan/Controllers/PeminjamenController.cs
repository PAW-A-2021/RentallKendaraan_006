...
namespace RentalKendaraan.Controllers
{
    public class PeminjamenController : Controller
    {
        ...
        [Authorize(Policy = "readonlypolicy")] //add
        // GET: Peminjamen
        public async Task<IActionResult> Index(string ktsd, string searchString, string sortOrder, string currentFilter, int? pageNumber)
        {
            ...
            var menu = from m in _context.Peminjamen.Include(p => p.IdCustomerNavigation).
                       Include(p => p.IdJaminanNavigation).Include(p => p.IdKendaraanNavigation) select m;
        ...
        [Authorize(Policy = "writepolicy")] //add
        ...
        [Authorize(Policy = "deletepolicy")] //add
